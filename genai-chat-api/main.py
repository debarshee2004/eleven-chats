        ...
        prompt_template = ChatPromptTemplate(
            [
                (
                    ...
                    Remember: Your reliability comes from staying within the bounds of the provided context. Users trust you because they know you won't make things up or add information that wasn't given to you. This makes you incredibly valuable for tasks requiring precision and accuracy.
